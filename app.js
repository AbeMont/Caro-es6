...
var iffeTest = function(){
  console.log("I've been invoked!");
};

var iffeTestInit = iffeTest();
...
const newSchool = ()=> (
   {
    init:2,
    animate:true,
    test: 'This has to return'
  }
);

console.log(newSchool());

// Es6 from class methods
...
// Make an Instance
const abe = new Person('Abe',27,true);
console.log(abe);

// Call the returned Object
var abeValues = abe.testing();
console.log(abeValues);
console.log(abe.testing());
